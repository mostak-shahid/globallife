...
$select = $globallife_options['sections-banner-select'];
$slides = $globallife_options['sections-banner-details'];
$shortcode = $globallife_options['sections-banner-shortcode'];
$n = 1;
