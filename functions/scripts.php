...
function globallife_enqueue_scripts() {
...
add_action( 'wp_enqueue_scripts', 'globallife_enqueue_scripts' );
function globallife_admin_enqueue_scripts(){
	wp_register_style( 'font-awesome.min', get_template_directory_uri() . '/fonts/font-awesome-4.7.0/css/font-awesome.min.css' );
...
add_action( 'admin_enqueue_scripts', 'globallife_admin_enqueue_scripts' );
