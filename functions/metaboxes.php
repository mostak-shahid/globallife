<?php
function globallife_metaboxes() {
    $prefix = '_globallife_';
    global $globallife_options,$template_parts;
    $blog_id = get_option( 'page_for_posts' );
    if (@$_GET['post'] == $blog_id){
        $enabled = ($globallife_options['archive-page-sections']['Enabled']) ? $globallife_options['archive-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($globallife_options['archive-page-sections']['Disabled']) ? $globallife_options['archive-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
    else{
        $enabled = ($globallife_options['general-page-sections']['Enabled']) ? $globallife_options['general-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($globallife_options['general-page-sections']['Disabled']) ? $globallife_options['general-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
...
add_action('cmb2_admin_init', 'globallife_metaboxes');