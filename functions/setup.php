<?php
//Add theme setup
if ( ! function_exists( 'globallife_setup' ) ) :
	function globallife_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'globallife'),
			'mobilemenu' => __('Mobile Menu', 'globallife'),
		));
...
add_action( 'after_setup_theme', 'globallife_setup' );