    ...
    class ReduxFramework_mos_address {
        ...
        public function render() {
             ...
             $defaults = array(
                ...
                'content_title' => __ ( 'Address', 'globallife' )
            );
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                   ...
                   if ( empty ( $slide[ 'thumb' ] ) && !empty ( $slide[ 'attachment_id' ] ) ) {
                    ...
                    echo '<span class="button media_upload_button" id="add_' . esc_attr( $x ) . '">' . esc_html__( 'Upload Map Image', 'globallife' ) . '</span>';
                    ...
                    echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-title_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][title]" value="' . esc_attr($slide['title']) . '" placeholder="'.esc_html__('Map Title', 'globallife').'" class="full-text slide-title" /></li>';
                    if ( $this->field[ 'show' ][ 'description' ] ) {
                        echo '<li><textarea name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][description]" id="' . esc_attr( $this->field['id'] ) . '-description_' . esc_attr( $x ) . '" placeholder="'.esc_attr__('Address', 'globallife').'" class="large-text" rows="6">' . esc_attr($slide['description']) . '</textarea></li>';
                    }
                    if ( $this->field[ 'show' ][ 'map_link' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-map_link_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][map_link]" value="' . esc_attr($slide['map_link']) . '" placeholder="'.esc_attr__('Map link', 'globallife').'" class="full-text" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'embeded_link' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-embeded_link_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][embeded_link]" value="' . esc_attr($slide['embeded_link']) . '" placeholder="'.esc_attr__('Embeded Map link', 'globallife').'" class="full-text" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'review_link' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-review_link_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][review_link]" value="' . esc_attr($slide['review_link']) . '" class="full-text" placeholder="'.esc_html__('Review Link', 'globallife').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'review_link_img' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-review_link_img_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][review_link_img]" value="' . esc_attr($slide['review_link_img']) . '" class="full-text" placeholder="'.esc_html__('Review Link Image', 'globallife').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'review_link_img_h' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-review_link_img_h_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][review_link_img_h]" value="' . esc_attr($slide['review_link_img_h']) . '" class="full-text" placeholder="'.esc_html__('Review Link Hover Image', 'globallife').'" /></li>';
                    }
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion redux-slides-remove">' . esc_html__('Delete Slide', 'globallife') . '</a></li>';
            ...
            if ($x == 0) {
                ...
                echo '<ul id="' . esc_attr( $this->field['id'] ) . '-ul" class="redux-slides-list">';
                $placeholder = (isset($this->field['placeholder']['title'])) ? esc_attr($this->field['placeholder']['title']) : __( 'Map Title', 'globallife' );
                ...
                if ( $this->field[ 'show' ][ 'description' ] ) {
                    $placeholder = (isset($this->field['placeholder']['description'])) ? esc_attr($this->field['placeholder']['description']) : __( 'Address', 'globallife' );
                ...
                if ( $this->field[ 'show' ][ 'map_link' ] ) {
                    $placeholder = (isset($this->field['placeholder']['map_link'])) ? esc_attr($this->field['placeholder']['map_link']) : __( 'Map link', 'globallife' );
                ...
                if ( $this->field[ 'show' ][ 'embeded_link' ] ) {
                    $placeholder = (isset($this->field['placeholder']['embeded_link'])) ? esc_attr($this->field['placeholder']['embeded_link']) : __( 'Embeded Map link', 'globallife' );
                ...
                if ( $this->field[ 'show' ][ 'review_link' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['review_link'])) ? esc_attr($this->field['placeholder']['review_link']) : __( 'Review Link', 'globallife' );
                ...
                if ( $this->field[ 'show' ][ 'review_link_img' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['review_link_img'])) ? esc_attr($this->field['placeholder']['review_link_img']) : __( 'Review Link Image', 'globallife' );
                ...
                if ( $this->field[ 'show' ][ 'review_link_img_h' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['review_link_img_h'])) ? esc_attr($this->field['placeholder']['review_link_img_h']) : __( 'Review Link Hover Image', 'globallife' );
